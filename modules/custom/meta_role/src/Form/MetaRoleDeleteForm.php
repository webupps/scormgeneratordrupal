 ...
 * @ingroup meta_role
 */
class MetaRoleDeleteForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete meta role %label?', [
  ...
  public function getConfirmText() {
    return $this->t('Delete Meta Role');
  }
  ...
  public function getCancelUrl() {
    return new Url('entity.meta_role.list');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage($this->t('Meta Role %label was deleted.', [
      '%label' => $this->entity->label(),
    ]));
